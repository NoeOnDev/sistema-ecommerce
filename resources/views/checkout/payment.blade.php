        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            <form action="{{ route('checkout.process.payment') }}" method="POST" id="payment-form">
                ...
                <div id="credit-card-form" class="border-t border-gray-200 pt-4">
                    ...
                    <p class="mb-3 text-sm text-gray-500">Este es un formulario de simulación. No ingreses datos reales de
                        tarjetas.</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label for="card_holder" class="block text-sm font-medium text-gray-700 mb-1">Nombre del
                                Titular</label>
                        ...
                        <div>
                            <label for="card_expiry" class="block text-sm font-medium text-gray-700 mb-1">Fecha de
                        ...
                        <div>
                            <label for="card_cvv" class="block text-sm font-medium text-gray-700 mb-1">Código de Seguridad
                                (CVV)</label>
